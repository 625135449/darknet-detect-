...
def image_detection(image_path, network, class_names, class_colors, thresh):
    ...
    # test = str(uuid.uuid4()) + '.jpg'
    #
    # path = os.path.join('/media/vs/Data/darknet_train_result/darknet/Helmet/helmet_new/PR/cv', test)
    #
    ...
    # return image, new_detections, class_colors
...
def main():
    ...
    yes_path = "/media/vs/Data/darknet_train_result/darknet/Helmet/helmet_new/PR/test2/images5"
    label_path = "/media/vs/Data/darknet_train_result/darknet/Helmet/helmet_new/PR/test2/labels5/"
    ...
    for root, dirs, files in os.walk(
            r"/media/vs/Data/darknet_train_result/darknet/Helmet/helmet_new/PR/error/img_ori"):  # 这里就填文件夹目录就可以了
        for file in files:
            # 获取文件路径
            if '.jpg' in file:
